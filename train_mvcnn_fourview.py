...
from models.MVCNN_attention import SVCNN,MVCNN_fourview,MVCNN_attention_fc_fourview
...
if __name__ == '__main__':
    ...
    create_folder(log_dir)
    cnet_2 = MVCNN_attention_fc_fourview(args.name, cnet, nclasses=40, cnn_name=args.cnn_name, num_views=args.num_views)
    del cnet
