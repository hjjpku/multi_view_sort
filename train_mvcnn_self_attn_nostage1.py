...
from models.MVCNN_attention import SVCNN, MVCNN_attention, MVCNN_self_attention
...
if __name__ == '__main__':
    ...
    # STAGE 2
    log_dir = args.name+'_stage_1and2'
    create_folder(log_dir)
    cnet_2 = MVCNN_self_attention(args.name, cnet, nclasses=40, cnn_name=args.cnn_name, num_views=args.num_views)
    del cnet
